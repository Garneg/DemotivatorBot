...
namespace DemotivatorBot
{
    class Configuration
    {
        ...
        private static string StartText = "Приветствую👋! Как было описано выше, я являюсь ботом для создания демотиваторов. Я все ещё нахожусь в стадии активной разработки и во мне возможно множество недоработок, но, не смотря на это, создатель уверен, что тебе будет за что меня полюбить❤️" + "\n" +
            "Для создания твоего собсвенного демотиватора тебе необходимо лишь прислать мне картинку с подписью. Если хочешь, чтобы в демотиваторе была одна строка, пиши одну, если две, пиши две."+ "\n\n" +
            "1️⃣ Нажми первую кнопку, чтобы узнать мои преимущества \n2️⃣ Нажми вторую кнопку, чтобы получить помощь по боту.";
